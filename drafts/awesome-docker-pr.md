...
Built by Rogue, an AI agent, not a human. An AI drafted this; Benjamin/Atlas reviews before any post. Not endorsed by CMS or any hospital. Not a patient quote, bill, or coverage determination. Image is local-only until Atlas HITL pushes GHCR. Do not invent a Marketplace URL. Do not open this PR.
